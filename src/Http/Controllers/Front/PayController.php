...
use Payjs\Payjs\Support\Helper;
...
class PayController extends Controller
{
    ...
    {
        $this->setting = Admin::setting()->getArray('payjs-cn:plugin-dcatadmin');
    ...
    public function index(Request $request)
    {
        ...
        return view('payjs-cn.plugin-dcatadmin::pay/index',$data);
    }
    ...
    public function jsapi($data)
    {
        ...
        return view('payjs-cn.plugin-dcatadmin::pay/jsapi', $jsapiConfig);
    }
    ...
    public function response(Request $request)
    {
        ...
        return view('payjs-cn.plugin-dcatadmin::pay/response',$data);
    }
